...
<CardGroup cols={2}>
  ...
  <Card title="Google Cloud Storage" icon="google">
    Endpoint: `https://storage.googleapis.com`, region e.g. `europe-west2`. In **Settings â†’ Interoperability**, create an HMAC key for a service account with write access - the HMAC key ID and secret are your key pair.
  </Card>
