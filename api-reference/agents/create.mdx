...
| `transfer_whisper` | string | No | `null` | Warm transfer briefing text. If empty, Claude auto-generates from the conversation. | 
ull | Warm transfer briefing text. If empty, Claude auto-generates from the conversation. |
