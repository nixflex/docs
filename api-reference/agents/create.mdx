...
| `system_prompt` | string | No | friendly assistant | The AI's instructions (max 8000 chars, about 2000 tokens) |
...
| Code | Cause |
|---|---|
| `prompt_too_long` | `system_prompt` exceeds 8000 characters |
