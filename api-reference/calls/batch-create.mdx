...
| `from_number` | string | Yes | The number to dial from. Must be a Twilio number you have imported and attached to this agent. Telnyx numbers cannot place outbound calls yet. |
