...
The engine looks up the last 2 voice calls from the customer's number and includes the call summaries plus usage instructions for Claude — the same way it does on inbound voice. Across channels, your AI feels continuous.
