...
The official Node.js SDK takes the same credential string and sets the header for you:
...
```
Keep the credential in an environment variable - never in client-side code. See the [quickstart](/quickstart#using-the-sdk) for a full example.
