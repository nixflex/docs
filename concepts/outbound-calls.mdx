...
The message comes from your prompt - see [Voicemail detection](/advanced/voicemail-detection) for how to control what it says, or to have the agent hang up without leaving anything.
