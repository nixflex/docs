...
|---|---|
| Standard voice | \$0.08 |
| **Inbound call someone actually listened to** | **\$0.09** |
...
<AccordionGroup>
  ...
  <Accordion title="Am I charged if nobody listens?">
    No. Enabling monitoring on a number is free, and calls nobody opens bill at the standard \$0.08/min. You are only charged the \$0.09 rate for a call someone actually listened to - and opening a live call even briefly puts that whole call on the higher rate.
  </Accordion>
