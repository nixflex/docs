...
An inbound call is a call placed **to** one of your imported numbers. The flow is automatic — once a number is imported, the agent answers.
...
<Steps>
  ...
  <Step title="Your carrier routes the call to Nixflex">
