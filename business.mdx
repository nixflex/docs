...
<Steps>
  ...
  <Step title="Pick a voice and language (optional)">
    Every agent uses the **Ashley** voice, and by default understands and replies in whichever language you write its instructions in - English, French, Spanish, German, Arabic and 25 more. If the caller speaks a different language, the agent offers to switch rather than switching on its own. To keep an agent to one language always, pick that language instead. Change either at any time.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Voicemail detection" icon="voicemail" href="/advanced/voicemail-detection">
    The agent spots an answering machine and ends the call, or leaves your message first if you switch that on.
  </Card>
  ...
  <Card title="Languages" icon="language" href="/concepts/languages">
    Thirty languages. Write your instructions in the language you want, and the agent offers to switch if a caller speaks another.
  </Card>
